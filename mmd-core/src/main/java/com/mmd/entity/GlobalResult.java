...
public class GlobalResult {
    ...
    public static GlobalResult paramsException() {
        return new GlobalResult(503, "请求参数异常", null);
    }

    public static GlobalResult notFound() {
        return new GlobalResult(504, "服务器未找到相关资源", null);
    }

    public static GlobalResult exception() {
        return new GlobalResult(500, "服务器发生异常", null);
    }
